class Tidyfiles < Formula
  include Language::Python::Virtualenv

  desc "AI-powered file organizer using rules + Claude Haiku"
  homepage "https://github.com/ayhid/tidyfiles"
  url "https://github.com/ayhid/tidyfiles/archive/refs/tags/v0.1.0.tar.gz"
  sha256 "c8fdb4e5e5addcfcbf8923e5de6108eb215f1dc5ecb867f6d75fd893070ce621"
  license "MIT"
  ...
  test do
    assert_match "AI-powered file organizer", shell_output("#{bin}/tidyfiles --help")
    assert_match version.to_s, shell_output("#{bin}/tidyfiles --version")

    # Test scan on an empty temp dir
    output = shell_output("#{bin}/tidyfiles scan #{testpath}")
    assert_match "No files found", output
  end
end
